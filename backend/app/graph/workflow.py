...
def build_workflow():
    ...
    workflow.add_conditional_edges("reviewer", review_router, {"coder": "coder", "documentation": "documentation"})
    workflow.add_edge("documentation", END)

    return workflow.compile()from __future__ import annotations
